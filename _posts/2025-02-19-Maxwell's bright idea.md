...
But we know that the divergence of the magnetic field vanishes so we can replace our curl of curl of $\mathbf{B}$ with just the negative Laplacian leading too
